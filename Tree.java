...
public class Tree {
 ...
 private void generateRandomTree(Node curNode, String[] funcSet, 
  ...
  if (method == "full"){      //run the Full Tree method
   ...
   generateGrowTree(curNode, funcSet, termSet, maxDepth);
  }
 ...
 private void generateFullTree(Node curNode, String[] funcSet,
  ...
  if (maxDepth < 1){
   ...
   curLeft = new Node(termSet[new Random().nextInt(funcSet.length)]);
   curRight = new Node(termSet[new Random().nextInt(funcSet.length)]);
